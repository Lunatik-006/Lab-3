...
winsound.PlaySound('forzatheme.wav', winsound.SND_FILENAME | winsound.SND_ASYNC | winsound.SND_LOOP)

bgnames_list=['forzapic1']
window = tk.Tk()
...
lbl_result = tk.Label(frame2, text="Not generated yet.", font=("Arial", 10))
